...
function windChill(){
const apiURL = 'https://api.openweathermap.org/data/2.5/weather?id=4005539&appid=a386af64b37968bdc5dcfeed5adf1e2c&units=imperial';
  ...
  //convert a response data in JavaScript object format.
   .then((jsObject) => {
     console.log(jsObject);
       ...
       // This code embeed the content on the HTML after the jsObject was call/created - forecast
...
function forecast(){
// this line create a variable to get the plain text JSON file
const apiURL2 = 'https://api.openweathermap.org/data/2.5/forecast?id=4005539&appid=a386af64b37968bdc5dcfeed5adf1e2c&units=imperial';
